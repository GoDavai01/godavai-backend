...
function botReply(userMsg) {
  ...
  return "I'm a GoDavaii Support Bot! Type your issue, or type 'human' to connect with our support team.";
}
  ...
  try {
    ...
    if (!chat) {
      chat = await SupportChat.create({
        ...
        orderId,
        messages: [
          { sender: "bot", text: "Hi! I am GoDavaii Support Bot. Tell me your issue, or type 'human' for a support agent." }
        ]
      });
    }
    res.json(chat);
